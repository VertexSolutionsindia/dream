...
public partial class Admin_Sales_entry_wholesales : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            float value = 0;
            SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
            SqlCommand cmd = new SqlCommand("insert into sales_entry_wholesale values(@invoice_no,@date,@customer_name,@customer_Address,@Mobile_no,@staff_name,@total_qty,@total_amount,@grand_total,@paid_amount,@Pending_amount,@status,@value,@Com_Id,@tax_per,@tax_amount,@tin_no,@payment_type)", CON);
            ...
            cmd.Parameters.AddWithValue("@tin_no", TextBox29.Text);
    ...
    protected void ImageButton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
    {
        ...
        TextBox30.Text = HttpUtility.HtmlDecode(row.Cells[2].Text);
        TextBox31.Text = HttpUtility.HtmlDecode(row.Cells[3].Text);
        TextBox32.Text = HttpUtility.HtmlDecode(row.Cells[4].Text);
        TextBox38.Text = HttpUtility.HtmlDecode(row.Cells[5].Text);
        TextBox34.Text = HttpUtility.HtmlDecode(row.Cells[6].Text);
        TextBox37.Text = HttpUtility.HtmlDecode(row.Cells[7].Text);
        this.ModalPopupExtender5.Show();
    ...
    protected void TextBox6_TextChanged(object sender, EventArgs e)
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                    ...
                    SqlCommand cmd2 = new SqlCommand("select * from customer_wholesale where Mobile_no='" + TextBox6.Text + "' and Com_Id='" + company_id + "'", con);
                    SqlDataReader dr1;
                    dr1 = cmd2.ExecuteReader();
                    if (dr1.Read())
                    {
                        ...
                        TextBox29.Text = dr1["tin_no"].ToString();
                    }
                    con.Close();
    ...
    protected void Button3_Click2(object sender, System.EventArgs e)
    {
            ...
            if (dr1.Read())
            {
                ...
                SqlConnection CON1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand cmd1 = new SqlCommand("insert into sales_entry_details_wholesale values(@invoice_no,@s_no,@Category,@Sub_category,@barcode,@Product_code,@product_name,@mrp,@size,@color,@qty,@total_amount,@Com_Id)", CON1);
    ...
    protected void Button16_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            cmd.Parameters.AddWithValue("@WSCustomer_Name", HttpUtility.HtmlDecode(TextBox19.Text));
            cmd.Parameters.AddWithValue("@WSCustomer_Add", HttpUtility.HtmlDecode(TextBox20.Text));
            ...
            cmd.Parameters.AddWithValue("@tin_no", TextBox23.Text);
            cmd.Parameters.AddWithValue("@cst_no", TextBox26.Text);
            cmd.Parameters.AddWithValue("@WSCustomer_code", Label29.Text);
            CON.Open();
            cmd.ExecuteNonQuery();
            CON.Close();
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Wholesale customer addded successfully')", true);
            BindData();
            show_type();
            getinvoicenoid();
            TextBox19.Text = "";
    ...
    protected void TextBox13_TextChanged(object sender, System.EventArgs e)
    {
        try
        {
            ...
            SqlCommand cmd2 = new SqlCommand("select * from customer_wholesale where WSCustomer_Name='" + TextBox13.Text + "' and Com_Id='" + company_id + "'", con);
            SqlDataReader dr1;
            dr1 = cmd2.ExecuteReader();
            if (dr1.Read())
            {
