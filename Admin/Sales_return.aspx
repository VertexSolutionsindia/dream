<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_return.aspx.cs" Inherits="Admin_Sales_return" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <div class="panel-body">
   ...
   <asp:AutoCompleteExtender ID="AutoCompleteExtender4" runat="server" MinimumPrefixLength="1" ServiceMethod="Searchinvoice" FirstRowSelected = "false" CompletionInterval="0" EnableCaching="false" CompletionSetCount="10" TargetControlID="TextBox19"  CompletionListCssClass="completionList"
  ...
  <asp:TextBox ID="TextBox17" runat="server" width="100px"></asp:TextBox>
   ...
   <asp:TextBox ID="TextBox18" runat="server" width="100px"></asp:TextBox>
     ...
     <asp:Button ID="Button3" runat="server" Text="Add Product" CssClass="btn-primary" 
      ...
      <asp:Button ID="Button5" runat="server" Text="Clear" CssClass="btn-primary" OnClick="Button5_Click"  ></asp:Button>
   ...
   <ContentTemplate>
    ...
    <asp:Panel ID="Panel5" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
     ...
     CompletionListHighlightedItemCssClass="itemHighlighted">
        ...
        <td>
            <asp:TextBox ID="TextBox35" runat="server"  class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label32" runat="server" Text="MRP" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox36" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
     <tr>
        <td>
            <asp:Label ID="Label33" runat="server" Text="Size" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
            <td>
            <asp:TextBox ID="TextBox39" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
            <tr>
        <td>
            <asp:Label ID="Label42" runat="server" Text="Color" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox37" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
         ...
         <tr>
             <td>
                 <asp:Label ID="Label34" runat="server" class="col-lg-3 control-label" 
                     Text="Qty" Width="200px"></asp:Label>
             </td>
             <td>
                 <asp:UpdatePanel ID="UpdatePanel42" runat="server">
                     <ContentTemplate>
                         <asp:TextBox ID="TextBox29" runat="server" AutoPostBack="true" 
                             class="form-control input-x2 dropbox" ontextchanged="TextBox29_TextChanged"></asp:TextBox>
                     </ContentTemplate>
                 </asp:UpdatePanel>
             </td>
         </tr>
         <tr>
             <td>
                 <asp:Label ID="Label35" runat="server" class="col-lg-3 control-label" 
                     Text="Dis Per" Width="200px"></asp:Label>
             </td>
             <td>
                 <asp:UpdatePanel ID="UpdatePanel45" runat="server">
                     <ContentTemplate>
                         <asp:TextBox ID="TextBox30" runat="server" AutoPostBack="true" 
                             class="form-control input-x2 dropbox" ontextchanged="TextBox30_TextChanged"></asp:TextBox>
                     </ContentTemplate>
                 </asp:UpdatePanel>
             </td>
         </tr>
         <tr>
             <td>
                 <asp:Label ID="Label36" runat="server" class="col-lg-3 control-label" 
                     Text="Dis amount" Width="200px"></asp:Label>
             </td>
             <td>
         ...
         <tr>
             <td>
                 <asp:Label ID="Label37" runat="server" class="col-lg-3 control-label" 
                     Text="Total amount" Width="200px"></asp:Label>
             </td>
             <td>
      ...
      <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="Button21" PopupControlID="Panel5" CancelControlID="ImageButton7" BackgroundCssClass="background"></asp:ModalPopupExtender>
