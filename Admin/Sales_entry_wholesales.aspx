...
<asp:Button ID="Button15" runat="server" Text="Button" style="display:none" />
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
       ...
       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
        ...
        <tr>
        <td>
            <asp:Label ID="Label28" runat="server" Text="Dream Id" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
     ...
     <tr>
        ...
        <tr>
        <td>
            <asp:Label ID="Label5" runat="server" Text="Tin No" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox23" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label10" runat="server" Text="Cst No" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Customer Tin No</label>
  ...
  <div class="col-md-12" >
   ...
   <ContentTemplate>
                 ...
                 <asp:AsyncPostBackTrigger ControlID="GridView1"  />
                                 ...
                                 <br />
                                <div class="form-group"><label class="col-lg-3 control-label">Tax %</label>
   ...
   <ContentTemplate>
                                ...
                                <br />
                                 <div class="form-group"><label class="col-lg-3 control-label">Tax amount</label>
