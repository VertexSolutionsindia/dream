...
public partial class Admin_Wholesales_report_details : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from sales_entry_wholesale where Com_Id='" + company_id + "' ORDER BY invoice_no desc", con);
    ...
    protected void TextBox4_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from sales_entry_wholesale where date between '" + TextBox3.Text + "' and '" + TextBox4.Text + "' and Com_Id='" + company_id + "' ORDER BY invoice_no Desc", con1);
        DataTable dt1 = new DataTable();
        con1.Open();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
    ...
    protected void TextBox5_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from sales_entry_wholesale where invoice_no='" + TextBox5.Text + "' and Com_Id='" + company_id + "' ORDER BY invoice_no desc", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
