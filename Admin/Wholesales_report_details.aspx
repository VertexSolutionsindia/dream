...
<div class="container">
 ...
 <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="3" 
       ...
       <Columns>
               ...
               <asp:BoundField HeaderText="Invoice No" DataField="invoice_no" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
           <asp:BoundField HeaderText="Date" DataField="date" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-CssClass="red" ItemStyle-CssClass="red"  />
           <asp:BoundField HeaderText="Customer Name" DataField="customer_name" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
             <asp:BoundField HeaderText="Staff name" DataField="staff_name" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
            
              <asp:BoundField HeaderText="total Qty" DataField="total_qty" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
               <asp:BoundField HeaderText="Total Amount" DataField="total_amount" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
               <asp:BoundField HeaderText="Grand total" DataField="grand_total" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
               <asp:BoundField HeaderText="paid Amount" DataField="paid_amount" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
               <asp:BoundField HeaderText="Pending Amount" DataField="Pending_amount" HeaderStyle-CssClass="red" ItemStyle-CssClass="red" />
              <asp:TemplateField>
              <ItemTemplate>
